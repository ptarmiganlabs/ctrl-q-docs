...
The columns are described on the [page describing app importing as part of task imports](/docs/command/qseow/import/task/#source-file-columns-for-app-import-definitions).

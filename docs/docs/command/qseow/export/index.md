...
[Save task to disk in tabular format](/docs/command/qseow/task/#example-save-task-to-disk-file-in-tabular-format)
...
The format of the created Excel file is almost identical to the one used when importing apps from QVF files, described [here](/docs/command/qseow/import/task/#source-file-columns-for-app-import-definitions).

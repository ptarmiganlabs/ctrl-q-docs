...
::: warning A note on screenshots and commands
...
Note: the `task-get` command has lots of options, these are described in more detail on [this page](/docs/command/qseow/task/#list-tasks-as-tree).
